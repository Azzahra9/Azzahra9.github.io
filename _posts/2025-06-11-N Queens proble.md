...
Deskripsi Singkat 
Masalah N-Queens adalah sebuah masalah klasik dalam bidang algoritma dan teori komputasi, yang berfokus pada penempatan sejumlah ratu (queen) di papan catur berdimensi N x N.
...
Bactracking dalam N-Queens Problem Backtracking adalah metode algoritma pencarian berbasis rekursi yang digunakan untuk menyelesaikan masalah dengan mencoba semua kemungkinan solusi secara sistematis, dan mundur (backtrack) jika suatu kemungkinan tidak menghasilkan solusi yang valid.
